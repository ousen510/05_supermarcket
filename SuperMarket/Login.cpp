...
BOOL CLogin::PreTranslateMessage(MSG* pMsg) 
{
	...
	if(pMsg->message == WM_LBUTTONDOWN)
	{
		...
		if(rect.PtInRect(point))
		{
			...
			CString sql;
			sql.Format("select * from mr.TB_USER where NAME='%s' and PWD='%s' and POPEDOM='1'",m_Name,m_PassWord);
...
//DEL void CLogin::CalcWindowRect(LPRECT lpClientRect, UINT nAdjustType) 
//DEL {
